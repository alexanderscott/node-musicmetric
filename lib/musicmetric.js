...
function Musicmetric (opts){
    if (!(this instanceof Musicmetric)) return new Musicmetric();
    opts = opts || {};
...
MusicMetric.getArtistCharts = function(opts, callback){
    _get('/chart/'+_chartUID(opts.chart), '', callback);
};

//Musicmetric.prototype.getArtistEvents = function(opts, cb, args){
    
//};

//Musicmetric.prototype.getArtistDemographics = function(opts, cb, args){
